...
- `references/quiz-types.md` — question composition rules: form quizzes are objective-only (选择+填空, stage-total ≤1 文字题), objective-conversion toolkit for deep probes, and the plan-quiz six-type spec. Read before generating any quiz.
